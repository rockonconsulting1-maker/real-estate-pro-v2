...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[8px] text-[13px] font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-surface border border-border text-foreground hover:bg-muted",
      ...
      size: {
        ...
        sm: "h-[28px] rounded-[6px] px-3 text-[12px]",
        lg: "h-11 rounded-[8px] px-8",
        icon: "h-[34px] w-[34px]",
        fab: "h-[54px] w-[54px] rounded-full shadow-2 bg-foreground text-background hover:bg-foreground/90",
      },
    },
    defaultVariants: {
      variant: "default",
